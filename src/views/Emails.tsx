      ...
      <div className={`${state.theme === 'dark'
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center space-x-2">
            <span className={`text-sm ${state.theme === 'dark' ? 'text-gray-400' : 'text-gray-600'
              }`}>
        ...
        <div className="divide-y divide-gray-200 dark:divide-gray-700">
          {state.emails.map((email, index) => (
            ...
            >
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    ...
                    <div className="flex items-center space-x-2 mt-1">
                      ...
                      <span className={`text-xs flex items-center ${state.theme === 'dark' ? 'text-gray-500' : 'text-gray-500'
                        }`}>
              ...
              <div className={`p-4 rounded-lg mb-4 ${state.theme === 'dark' ? 'bg-gray-700' : 'bg-gray-100'
                }`}>
                <div className="flex items-center space-x-2 mb-2">
                  <div className="w-2 h-2 bg-blue-500 rounded-full" />
                  <span className={`text-sm font-medium ${state.theme === 'dark' ? 'text-gray-300' : 'text-gray-700'
                    }`}>
                    AI Summary
                  </span>
                </div>
              ...
              {email.suggestedReply && (
                <div className={`p-4 rounded-lg ${state.theme === 'dark' ? 'bg-green-900/20' : 'bg-green-50'
                  }`}>
                  <div className="flex items-center space-x-2 mb-2">
                    <Reply className={`w-4 h-4 ${state.theme === 'dark' ? 'text-green-400' : 'text-green-600'
                      }`} />
                    <span className={`text-sm font-medium ${state.theme === 'dark' ? 'text-green-400' : 'text-green-700'
                      }`}>
                      AI Suggested Reply
                    </span>
                  </div>
                  <p className={`text-sm mb-3 ${state.theme === 'dark' ? 'text-green-300' : 'text-green-700'
                    }`}>
                    {email.suggestedReply}
                  </p>
          ...
          {state.emails.length === 0 && (
            <div className={`text-center py-12 ${state.theme === 'dark' ? 'text-gray-500' : 'text-gray-500'
              }`}>
